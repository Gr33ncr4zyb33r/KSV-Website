      ...
      <ion-card>
        <ion-card-header>
          <ion-card-title class="title">
            ...
            Einladung zur KSV-Jahreshauptversammlung
          </ion-card-title>
          <ion-card-subtitle>
            <ion-icon name="location-outline" slot="start"></ion-icon>
            06. April 2025 - Im Waldhorn, Gausbach
          </ion-card-subtitle>
        </ion-card-header>
        ...
        <ion-card-content>
          ...
          <ion-chip>
            ...
            <ion-label>Im Waldhorn, Gausbach</ion-label>
          </ion-chip>

          <ion-chip>
            <ion-icon name="time" ></ion-icon>
            <ion-label>Beginn: 17:00 Uhr</ion-label>
          </ion-chip>

          <ion-chip>
            <ion-icon name="cash" ></ion-icon>
            <ion-label>Buffetpreis: 25 €</ion-label>
          </ion-chip>



          <h2 class="section-title" style="padding-top: 20px">
            Tagesordnung:
          </h2>
          <ul>
            <li>
              <span class="highlight">Begrüßung / Rückblick</span> – 1. Vorsitzender
            </li>
            <li>
              <span class="highlight">Bericht der Kassiererin</span>
            </li>
            <li>
              <span class="highlight">Entlastung der Vorstandschaft</span>
            </li>
            <li>
              <span class="highlight">Neuwahlen</span>
            </li>
            <li>
              <span class="highlight">Erhöhung des Vereinsbeitrags</span>
            </li>
            <li>
              <span class="highlight">Eventuelle Erweiterung der Trainingsfläche</span> in den nächsten Jahren
            </li>
            <li>
              <span class="highlight">Geplante Renovierungen der Trainingsräume</span> (Sanierung der Wände)
            </li>
          </ul>
          ...
          <p class="info" style="padding-top: 20px">
            Wer möchte, darf sich gerne im Voraus bei Marvin Wunsch für das Buffet anmelden (Kosten: 25 Euro).
          </p>
