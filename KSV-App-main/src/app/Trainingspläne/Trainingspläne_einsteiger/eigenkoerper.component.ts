...
@Component({
  ...
  template: `
    ...
    <ion-content class="ganz">
      <ion-card>
        <ion-card-header>
          <ion-card-title>Körpergewichtstraining</ion-card-title>
      ...
      <ion-accordion-group #accordionGroup multiple="timerRunning">
        ...
        <ion-accordion  value="first">
          <ion-item slot="header">
            <ion-label>
              <h2>Liegestütze erhöhte Beinposition</h2>
              <p>Brust/Schultern</p>
            </ion-label>
          </ion-item>
        ...
        <ion-accordion value="fourth">
          <ion-item slot="header">
            <ion-label>
              <h2>Liegestütze erhöte Oberkörperpos.</h2>
              <p>Brust</p>
            </ion-label>
          </ion-item>
          <div class="ion-padding" slot="content">
        ...
        <ion-accordion value="seventh">
          <ion-item slot="header">
            <ion-label>
              <h2>Abwechselnde Ausfallschritte</h2>
              <p>Beine</p>
            </ion-label>
          </ion-item>
          <div class="ion-padding" slot="content"><ion-grid class="satz">
        ...
        <ion-accordion value="eigth">
          <ion-item slot="header">
            <ion-label>
              <h2>Wandsitzen mit Wadenheben abwechselnd</h2>
              <p>Beine/Waden</p>
            </ion-label>
          </ion-item>
          <div class="ion-padding" slot="content"><ion-grid class="satz">
            <ion-row>
              <ion-col>Satz</ion-col>
              <ion-col>Dauer</ion-col>
              <ion-col *ngIf="trainingRunning">erledigt?</ion-col>
            </ion-row>
            <ion-row>
              <ion-col>1</ion-col>
              <ion-col>30-60 sek.</ion-col>
...
export class EigenkoerperComponent {
  timerValue: number = 0;
