      ...
      <ion-card>
        ...
        <ion-card-content>
          ...
          <ng-template #staticContent>
            ...
            <iframe src="https://www.youtube.com/embed/JOwsQyZQo3w?si=bEDIU0Ao6j7_wTdO"
            ...
            <ion-chip color="darkred">
              ...
              <ion-label>Langhantel</ion-label>
            </ion-chip>
            <ion-chip color="darkred">
            ...
            <ion-row>
              <ion-col>
                <ion-button expand="block" (click)="toggleTimer()" (click)="toggleAccordion()">
                  <ion-icon style="padding: 0" slot="start"
                            [name]="timerPaused ? 'play' : 'pause'">{{ timerButtonText }}</ion-icon>
                  {{ timerButtonText }}
                </ion-button>
              </ion-col>
              <ion-col>
                <ion-button id="present-alert" color="danger" expand="block" *ngIf="timerRunning"
                            (click)="showStopAlert()">
                  <ion-icon style="padding: 0" slot="start" name="stop"></ion-icon>
                  Stop
                </ion-button>
              </ion-col>
            </ion-row>
