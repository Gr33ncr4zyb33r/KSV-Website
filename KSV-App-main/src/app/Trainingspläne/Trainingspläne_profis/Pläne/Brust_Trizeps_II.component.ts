...
@Component({
  selector: 'app-page-BrustTrizepsII',
  ...
  template: `
    ...
    <ion-header>
      <ion-toolbar>
        ...
        <ion-title>Brust/Trizeps</ion-title>
      </ion-toolbar>
    </ion-header>
    ...
    <ion-content class="ganz">
      <ion-card>
        <ion-card-header>
          <ion-card-title>Brust/Trizeps</ion-card-title>
      ...
      <ion-accordion-group #accordionGroup multiple="timerRunning">
        ...
        <ion-accordion value="third">
          <ion-item slot="header">
            <ion-label>
              <h2>Schrägbankdrücken (Multipresse)</h2>
              <p>Brust</p>
            </ion-label>
          </ion-item>
          <div class="ion-padding" slot="content">
        ...
        <ion-accordion value="sixth">
          <ion-item slot="header">
            <ion-label>
              <h2>Trizepsdrücken über Kopf am Seil</h2>
              <p>Arme</p>
            </ion-label>
          </ion-item>
          <div class="ion-padding" slot="content"><ion-grid class="satz">
...
export class Brust_Trizeps_IIComponent {
  timerValue: number = 0;
