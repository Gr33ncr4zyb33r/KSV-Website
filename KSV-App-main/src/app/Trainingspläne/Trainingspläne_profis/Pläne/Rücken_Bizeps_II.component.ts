...
@Component({
  selector: 'app-page-RueckenBizepsII',
  ...
  template: `
    ...
    <ion-header>
      <ion-toolbar>
        ...
        <ion-title>Rücken/Bizeps</ion-title>
      </ion-toolbar>
    </ion-header>
    ...
    <ion-content class="ganz">
      <ion-card>
        <ion-card-header>
          <ion-card-title>Rücken/Bizeps</ion-card-title>
      ...
      <ion-accordion-group #accordionGroup multiple="timerRunning">
        ...
        <ion-accordion value="fifth">
          <ion-item slot="header">
            <ion-label>
              <h2>Vorgebeugtes Rudern Untergriff Langhantel</h2>
              <p>Rücken</p>
            </ion-label>
          </ion-item>
        ...
        <ion-accordion value="seventh">
          <ion-item slot="header">
            <ion-label>
              <h2>Hammercurls mit dem Seil</h2>
              <p>Arme</p>
            </ion-label>
          </ion-item>
          <div class="ion-padding" slot="content"><ion-grid class="satz">
...
export class Ruecken_Bizeps_IIComponent {
  timerValue: number = 0;
